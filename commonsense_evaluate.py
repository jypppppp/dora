    ...
    if args.adapter == "LoRA" or args.adapter == "DoRA":
        ...
        for key,module in key_list:
            ...
            if target_module_found:
                ...
                if args.is_sine:
                    module.is_sine = True
                    print(f"is_sine {module.is_sine}")
                    module.s = args.s
                    module.freq = args.freq
...
def parse_args():
    ...
    parser.add_argument('--dataset', choices=["boolq", "piqa", "social_i_qa", "hellaswag", "winogrande", "ARC-Challenge", "ARC-Easy", "openbookqa"],
                        required=True)
    parser.add_argument('--model', choices=['LLaMA2-7B'], required=True)
    ...
    parser.add_argument('--is_sine',  action='store_true',required=False)
